    ...
    public class Routers
    {
        public static void Optimum(string pathInput, string pathOutput)
        {
            ...
            while (current != null)
            {
                ...
                currentVertex = Convert.ToInt32(fragmentized[fragmentized.Length - 2]);
                currentWeight = Convert.ToInt32(fragmentized[fragmentized.Length - 1][1..(fragmentized[fragmentized.Length - 1].Length - 1)]);
