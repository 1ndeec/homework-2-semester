...
/// <summary>
/// Provides a realization of math expression parser.
/// </summary>
public static class Parser
{
    ...
    public static Node Parse(string input)
    {
        ...
        if (!OperatorMap.Contains(operatorSymbol))
        {
        ...
        return OperatorMap.ReturnConstructor(operatorSymbol, leftChild, rightChild);
    }
}