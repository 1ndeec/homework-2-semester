...
public class Trie
{
    ...
    public class Vertex
    {
        private Dictionary<char, Vertex> next; // array of vertexes in which you can go from this vertex
        ...
        {
            return this.next.ContainsKey(letter);
        }
        ...
        {
            this.next.Add(letter, new Vertex(false));
        }
        ...
        public Vertex GetFromNext(char letter)
        {
            ...
            {
                throw new ArgumentException($"No such char as '{letter}' in trie.");
            }
